 ...
 */
final class Version20230414194335 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE favplaces (id INT AUTO_INCREMENT NOT NULL, Place_Id INT DEFAULT NULL, id_User INT DEFAULT NULL, INDEX favuser_idUser (id_User), INDEX favplace_idplace (Place_Id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
