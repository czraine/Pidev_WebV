 ...
 * Review
 *
 * @ORM\Table(name="review", uniqueConstraints={@ORM\UniqueConstraint(name="place_id_2", columns={"place_Id"}), @ORM\UniqueConstraint(name="place_Id_3", columns={"place_Id"})}, indexes={@ORM\Index(name="reviewPlace", columns={"id_User"}), @ORM\Index(name="place_Id", columns={"place_Id"}), @ORM\Index(name="place_Id_4", columns={"place_Id"})})
 * @ORM\Entity
 */
class Review
{
